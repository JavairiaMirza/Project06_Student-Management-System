...
if(ans.choices === '1. New Student Form'){
    var newStd:{
        name:string,
        Age:number,
        Id:string|number|undefined,
...
if(ans.choices === '2. Search Student by ID'){
...
if (ans.choices === '3. Show all Students'){
    console.log(allStudents);
}



if(ans.choices === '4. Update Record'){
